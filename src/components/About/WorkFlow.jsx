        ...
        <SplideSlide>
          <div className="flex flex-col lg:flex-row items-center lg:items-start p-5 sm:p-20 sm:mt-10 mt-5">
            <div className="lg:w-1/2 w-full py-6 lg:mr-10 bg-white shadow-lg rounded-lg lg:absolute z-50">
              ...
              Our remarkable projects demonstrate excellence, professionalism, dedication, and client satisfaction.
              </p>
        ...
        <SplideSlide>
          <div className="flex flex-col lg:flex-row items-center lg:items-start p-5 sm:p-20 sm:mt-10 mt-5">
            <div className="lg:w-1/2 w-full py-6 lg:mr-10 bg-white shadow-lg rounded-lg lg:absolute z-50">
              <h2 className="text-3xl font-bold mb-4 pl-5">Working for Us</h2>
              <p className="mb-4 pl-5">
              Each completed project reflects our commitment to quality, innovation, trust, and precision.
              </p>
        ...
        <SplideSlide>
          <div className="flex flex-col lg:flex-row items-center lg:items-start p-5 sm:p-20 sm:mt-10 mt-5">
            <div className="lg:w-1/2 w-full py-6 lg:mr-10 bg-white shadow-lg rounded-lg lg:absolute z-50">
              <h2 className="text-3xl font-bold mb-4 pl-5">Working for Us</h2>
              <p className="mb-4 pl-5">
              Explore our outstanding achievements built with reliability, superior craftsmanship, and attention to detail.
