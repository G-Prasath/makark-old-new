      ...
      <div className="dark:bg-gray-800 grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 lg:gap-8 md:gap-12 gap-14 lg:px-20 lg:py-12 py-10 md:px-12 px-4">
        ...
        <div className="flex flex-col items-center justify-center">
          ...
          <p className="text-base leading-6 font-normal dark:text-gray-300 text-gray-600 mt-4 lg:w-full md:w-9/12 w-full">
            Free worldwide delivery over orders above. Free worldwide delivery over orders above
          </p>
        </div>
        ...
        <div className="flex flex-col items-center justify-center">
          ...
          <p className="text-base leading-6 font-normal dark:text-gray-300 text-gray-600 mt-4 lg:w-full md:w-9/12 w-full">
            All out products are 100 percent recycable. All out products are 100 percent recycable
          </p>
        </div>
        ...
        <div className="flex flex-col items-center justify-center">
          ...
          <p className="text-base leading-6 font-normal dark:text-gray-300 text-gray-600 mt-4 lg:w-full md:w-9/12 w-full">
            Transaction process has end-to-end encryption. Transaction process has end
          </p>
        </div>
      </div>
    </div>
