...
import { SpaceFrameStructureData as allData } from "../data/ServicesData";
import { Spaceframestructures_PageMeta as metaTags } from "../data/Metatags";

const SpaceFrameStructure = () => {
  const pageName = "Space Frame Structure";
  return (
    <div>
      <Helmet>
...
export default SpaceFrameStructure;
